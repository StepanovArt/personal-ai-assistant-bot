...
## ~~Фаза 6 — Онбординг и безопасность~~ ✅ DONE
...
### 8.2 Агент-экстрактор (`agents/expense_agent.py`)
...
## Фаза 9 — Полировка под портфолио (из PLAN.md Фаза 3)
...
### 9.3 Опционально: `/report` с графиком
- matplotlib: расходы по категориям за период → картинка в чат

---

## Фаза 10 — Код-ревью (из PLAN.md Фаза 4)
